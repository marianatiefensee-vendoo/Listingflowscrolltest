              ...
              <div className="flex-1 min-w-0">
                <CreateItemLayout
                  ...
                  children={{
                    ...
                    pricing: <PricingContent isAIGenerated={wasAIGeneratedFromPhotos} shouldExpand={shouldExpandPricing} onExpandChange={() => setShouldExpandPricing(false)} onContinue={handleContinueFromPricing} onPriceChange={setListingPrice} initialPrice={itemDetails?.suggestedPrice ? itemDetails.suggestedPrice.replace(/[^0-9.]/g, '') : undefined} shouldCollapse={shouldCollapsePricing} onCollapseChange={() => setShouldCollapsePricing(false)} onManualExpand={handleManualExpandPricing} />,
