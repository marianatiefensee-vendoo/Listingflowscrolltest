import svgPaths from "./svg-qt0lwj09d3";
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-center min-h-px min-w-px relative self-stretch">
      <p className="flex-[1_0_0] font-['Lexend:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px relative text-[#7a7486] text-[14px] tracking-[0.25px]">Vintage 90s Nike Air Max Sneakers…</p>
    </div>
  );
}
...
function Title() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-start min-h-px min-w-px relative" data-name="Title">
