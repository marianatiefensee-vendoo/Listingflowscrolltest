import svgPaths from "./svg-ge4ovs184p";
...
function StateLayer() {
  return (
    <div className="bg-[rgba(29,26,36,0.08)] content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px px-[16px] relative rounded-[5px]" data-name="State - Layer">
...
function Content() {
  return (
    <div className="content-stretch flex flex-col h-full items-center justify-center relative rounded-[5px] shrink-0" data-name="Content">
      <StateLayer />
    </div>
  );
}
