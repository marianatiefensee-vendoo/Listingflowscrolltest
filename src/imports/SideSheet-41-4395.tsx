import svgPaths from "./svg-qztxlx04pl";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="content-stretch cursor-pointer flex items-center overflow-clip relative shrink-0 w-full" data-name="Tabs/Marketplace Tabs">
        ...
        <button className="content-stretch flex flex-[1_0_0] flex-col items-center justify-end min-h-px min-w-px overflow-clip relative rounded-bl-[12px] rounded-tl-[12px]" data-name="Pricing">
          <StateLayer3 />
        </button>
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="Title">
      <div className="flex flex-col font-['Lexend:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#494455] text-[16px] text-left tracking-[0.15px] whitespace-nowrap">
        <p className="leading-[24px]">Pricing Format</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[4px] py-[10px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Lexend:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px relative text-[#7a7486] text-[16px] text-left tracking-[0.5px]">
            <p className="leading-[24px]">Pricing Policy Default</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Input text container">
      <div className="flex flex-col font-['Lexend:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#7a7486] text-[16px] tracking-[0.5px] whitespace-nowrap">
        <p className="leading-[24px]">Good til’ canceled</p>
      </div>
    </div>
  );
}
...
function Title2() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Title">
      <div className="flex flex-col font-['Lexend:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#494455] text-[16px] tracking-[0.15px] whitespace-nowrap">
        <p className="leading-[24px]">{`Buy it now `}</p>
      </div>
    </div>
  );
}
...
function Title3() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Title">
      <div className="flex flex-col font-['Lexend:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#494455] text-[16px] tracking-[0.15px] whitespace-nowrap">
        <p className="leading-[24px]">Starting bid</p>
      </div>
    </div>
  );
}
...
function HandleShape() {
  return (
    <div className="bg-[#1d1a24] content-stretch flex items-center justify-center opacity-38 overflow-clip p-[11px] relative rounded-[24px] shrink-0" data-name="Handle shape">
      <div className="opacity-38 rounded-[100px] shrink-0 size-[2px]" data-name="Container" />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 opacity-38 overflow-clip size-[16px] top-1/2" data-name="Icon">
        <div className="absolute inset-[16.67%]" data-name="Icon">
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Lexend:Medium',sans-serif] font-medium justify-center leading-[0] opacity-38 relative shrink-0 text-[#494455] text-[16px] tracking-[0.15px] whitespace-nowrap">
        <p className="leading-[24px]">Allow Best Offer</p>
      </div>
      <div className="bg-[rgba(231,223,244,0.1)] content-stretch flex items-center p-[4px] relative rounded-[100px] shrink-0" data-name="Switch_Toggle">
        <div aria-hidden="true" className="absolute border-2 border-[rgba(29,26,36,0.1)] border-solid inset-0 pointer-events-none rounded-[100px]" />
        <Handle />
      </div>
      <SupportingText5 />
    </div>
...
function Title5() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Title">
      <div className="flex flex-col font-['Lexend:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#494455] text-[16px] tracking-[0.15px] whitespace-nowrap">
        <p className="leading-[24px]">Auto accept</p>
      </div>
    </div>
  );
}
...
function Title6() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Title">
      <div className="flex flex-col font-['Lexend:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#494455] text-[16px] tracking-[0.15px] whitespace-nowrap">
        <p className="leading-[24px]">Minimum offer</p>
      </div>
    </div>
  );
}
