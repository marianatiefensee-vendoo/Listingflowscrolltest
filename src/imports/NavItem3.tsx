import svgPaths from "./svg-bcrt9nsfcl";

function StateLayer() {
  return (
    <div className="bg-[rgba(29,26,36,0.08)] content-stretch flex gap-[8px] isolate items-center justify-center p-[16px] relative rounded-[12px] shrink-0" data-name="State layer">
...
export default function NavItem() {
  return (
    <button className="content-stretch cursor-pointer flex items-center relative size-full" data-name="Nav item 3">
      <StateLayer />
    </button>
  );
}